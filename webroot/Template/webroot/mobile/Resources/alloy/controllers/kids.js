function Controller() {
    function __alloyId11() {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId9 = Ti.UI.createTableViewRow({
                dataId: "undefined" != typeof __alloyId8.__transform["id"] ? __alloyId8.__transform["id"] : __alloyId8.get("id"),
    ...
    var __alloyId10 = Alloy.Collections["Kid"] || Kid;
    ...
    __alloyId14.push($.__views.camera);
    ...
    __alloyId14.push($.__views.refresh);
    ...
    __alloyId14.push($.__views.addbtn);
    ...
    $.__views.tblviewWindow.add($.__views.__alloyId12);
