<div class="pobjects index">
	...
	<tr>
		<td><?php echo h($pobject['Pobject']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($pobject['Project']['name'], array('controller' => 'projects', 'action' => 'view', $pobject['Project']['id'])); ?>
		</td>
		<td><?php echo h($pobject['Pobject']['name']); ?>&nbsp;</td>
		<td><?php echo h($pobject['Pobject']['description']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $pobject['Pobject']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $pobject['Pobject']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $pobject['Pobject']['id']), null, __('Are you sure you want to delete # %s?', $pobject['Pobject']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
